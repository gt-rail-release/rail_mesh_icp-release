## rail_mesh_icp (melodic) - 0.0.4-1

The packages in the `rail_mesh_icp` repository were released into the `melodic` distro by running `/usr/bin/bloom-release rail_mesh_icp --rosdistro melodic --edit` on `Wed, 30 Oct 2019 15:47:56 -0000`
